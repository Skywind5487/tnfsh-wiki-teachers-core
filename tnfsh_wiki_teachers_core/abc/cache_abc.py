...
class BaseCacheABC(ABC):
    ...
    @abstractmethod
    async def fetch(self, *args, refresh: bool = False, **kwargs) -> TResult:
        """統一對外取得資料（自動處理 memory/file/source）"""
        pass

    @abstractmethod
    async def fetch_from_memory(self, *args, **kwargs) -> Optional[TResult]:
        """從記憶體快取取得資料"""
        pass
    ...
    @abstractmethod
    async def fetch_from_file(self, *args, **kwargs) -> Optional[TResult]:
        """從本地檔案快取取得資料"""
        pass
